...
def Step2():
    ...
    LeftWheel.off()
z    RightWheel.off    
    #TankPair.on_for_degrees(SpeedDPS(0),SpeedDPS(-100),140,True,True)
    #TankPair.on_for_degrees(SpeedDPS(-250),SpeedDPS(-250), 205,True,True)
def Step3():
...
def Step4():
    TankPair.on_for_degrees(SpeedDPS(-250),SpeedDPS(-255), 500,True,True)
