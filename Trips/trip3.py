...
def Step7():
    TankPair.on_for_degrees(SpeedDPS(-250),SpeedDPS(-250), 1325,True,True)
...
def Step8():
    ...
    TankPair.on_for_degrees(SpeedDPS(-200),SpeedDPS(-200),20,True,True)
...
def Step9():
    ...
    RightWheel.off()
    LeftWheel.off()
    TankPair.on_for_degrees(SpeedDPS(-200),SpeedDPS(0),15,True,True)
