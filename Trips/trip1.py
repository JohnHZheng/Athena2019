...
def Trip1Tryout(): 
    ...
    # robot.run(35,-20) # move robot to the starting point of the line
    ...
    robot.lineFollow(useLeftSensor = True, useLeftEdge = False, useBackSensor = True, runDistanceCM = 46, scale=.12)
