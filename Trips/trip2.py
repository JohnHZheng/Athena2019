...
sound           = Sound()
def runTrip2():
    TankPair.on_for_degrees(SpeedDPS(-145),SpeedDPS(-130), 750,False,True)
    TankPair.on_for_degrees(SpeedDPS(80),SpeedDPS(80), 250,True,True)
    TankPair.on_for_degrees(SpeedDPS(400),SpeedDPS(400), 350,True,True)
    TankPair.on_for_degrees(SpeedDPS(-400),SpeedDPS(400), 270,True,True)
    TankPair.on_for_degrees(SpeedDPS(400),SpeedDPS(400), 650,True,True)
    TankPair.on_for_degrees(SpeedDPS(400),SpeedDPS(-400), 350,True,True)
